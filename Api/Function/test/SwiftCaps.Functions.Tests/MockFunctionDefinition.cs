...
namespace SwiftCaps.Functions.Tests
{
    public class MockFunctionDefinition : FunctionDefinition
    {
        ...
        public MockFunctionDefinition(string functionId = null, IDictionary<string, BindingMetadata> inputBindings = null, IDictionary<string, BindingMetadata> outputBindings = null, IEnumerable<FunctionParameter> parameters = null)
        {
