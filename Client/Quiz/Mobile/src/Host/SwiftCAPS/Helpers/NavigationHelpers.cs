...
{
    // TODO : Move to Shared assembly (if we need it)
    public static class NavigationHelpers
    {
        // It provides a navigatable section for elements which aren't explicitly defined within the Shell.
        // For example, ProductCategoryPage: it's accessed from the fly-out through a MenuItem but it doesn't belong to any section
